...
`.brightWhite)
    ...
    console.log(`                      ATTACK STARTED BY ZAI`.red)
    console.log(`                 ▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰`.gray)
    console.log(`                    HOST:  `.blue + process.argv[2])
    console.log(`                    TIMES: `.blue + process.argv[3])
    console.log(`                    RATE:  `.blue + process.argv[4])
    console.log(`                    THREAD:`.blue + process.argv[5])
    console.log(`                 ▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰`.gray)
    console.log('                          '.cyan + tipsz)
